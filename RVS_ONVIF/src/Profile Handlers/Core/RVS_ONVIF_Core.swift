...
public class RVS_ONVIF_Core: ProfileHandlerProtocol {
    ...
    /* ################################################################## */
    /**
     This asks the device to send over its WSDL URI. The delegate call will be made when it is received.
     */
    public func fetchWsdlUrl() {
        owner.performRequest(_DeviceRequest.GetWsdlUrl)
    }
    
    /* ################################################################## */
    /**
     This asks the device to send over its hostname. The delegate call will be made when it is received.
     */
    public func fetchHostname() {
        owner.performRequest(_DeviceRequest.GetHostname)
    }
    ...
    public func setHostname(_ inHostname: String) {
        owner.performRequest(_DeviceRequest.SetHostname, params: ["Name": inHostname])
    }
     ...
     */
    public func setDNS(_ inDNSEntry: DNSRecord) {
        ...
        owner.performRequest(_DeviceRequest.SetDNS, params: params)
    }
     ...
     */
    public func setNTP(_ inNTPEntry: NTPRecord) {
        var params: [String: Any] = [:]
        ...
        owner.performRequest(_DeviceRequest.SetNTP, params: params)
    }
     ...
     */
    public func setDynamicDNS(_ inDynDNSEntry: DynamicDNSRecord) {
        var params: [String: Any] = [:]
        ...
        owner.performRequest(_DeviceRequest.SetDynamicDNS, params: params)
    }
